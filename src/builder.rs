...
use crate::{traits::{
    ...
    DefaultFrontmatterGenerator,
    FrontmatterGenerator,
    page_provider::{PageProvider, DatabasePageProvider}
}, NotionToObsidian};
...
impl NotionToObsidianBuilder {
    ...
    pub fn with_page_provider(self, page_provider: Box<dyn PageProvider>) -> NotionToObsidianBuilder {
        NotionToObsidianBuilder {page_provider, ..self}
    }
